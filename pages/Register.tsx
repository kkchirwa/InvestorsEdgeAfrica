...
const Register: React.FC = () => {
  const { registrationConfig } = useData();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    // Redirecting directly to the external ticket website
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center pt-4">
                  <div className="flex-1 space-y-4 w-full">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-[10px] uppercase font-bold text-slate-400">Attendee</p>
                        <p className="font-bold text-lg leading-none">{formData.fullName}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center text-slate-400">
                      ...
                      <div>
                        ...
                        <p className="font-bold text-lg leading-none">{formData.institution}</p>
                      </div>
                    </div>
                  </div>
    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row relative">
      ...
      <div className="md:w-[60%] bg-slate-50 flex items-center justify-center p-8 md:p-12 relative">
        <div className="w-full max-w-lg">
          <div className="mb-10">
            <h2 className="text-3xl font-bold text-slate-900 mb-2">Student Details</h2>
            <p className="text-slate-500">Please provide your academic information below.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full py-5 bg-brand-blue text-white font-bold rounded-xl shadow-xl hover:bg-blue-800 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3"
              >
